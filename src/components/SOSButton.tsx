...
import { StyleSheet, TouchableOpacity, View, Text, Alert, ActivityIndicator, Modal, TouchableWithoutFeedback, Animated } from 'react-native';
...
export const SOSButton = () => {
  ...
  const handleSOSPress = async () => {
    if(locked){ Alert.alert('Request locked', 'You already have an active emergency.'); return }
  console.log('SOS button pressed - opening selector');
  Alert.alert('Choose Emergency', 'Please choose the type of emergency you want to report');
  ...
  const sendWithType = async (type: 'MEDICAL' | 'FIRE' | 'FLOOD' | 'EARTHQUAKE') => {
    // Instead of sending immediately, show a cancel modal with 5s countdown
